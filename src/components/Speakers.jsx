...
const SpeakersPage = () => {
    ...
    return (
        <div  className="speakersPage-container">
            ...
            <div className="speakers-products-section">
                <div className="speakers-products-section-cardContainer">
                    <div className='speakers-product-imageDiv'><img src="/speakerZX9.jpg" alt="" /></div>
                    <div className="speakers-product-textDiv">
                       <h2>NEW PRODUCT</h2> 
                       <h3>ZX9 SPEAKER</h3>
                       <p>Upgrade your sound experience with the ZX9 speaker. Featuring a revolutionary new design, the ZX9 delivers exceptional sound quality and a sleek aesthetic that complements any room.</p>
                   <div><a href="/productDetails/5">SEE PRODUCT</a></div>
                    </div>
                </div>
                
                <div  className="speakers-products-section-cardContainer">
                    <div className='speakers-product-imageDiv'><img src="/speakerZX7.jpg" alt="" /></div>
                    <div className="speakers-product-textDiv">
                         <h3>ZX7 SPEAKER</h3>
